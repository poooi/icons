...
- Lettering is bold Mincho/serif. The current outlined lettering uses Noto Serif JP ExtraBold (800); Source Han Serif or an appropriate free bold Japanese Mincho is also consistent with the design direction. Do not substitute sans-serif lettering. Deliver paths rather than requiring a font installation.
